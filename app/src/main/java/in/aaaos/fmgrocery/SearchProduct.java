...
public class SearchProduct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(searchval.getText().toString().trim().isEmpty()){
                    searchval.setError("Please write something to search");
                }
                else {
                    i=0;
    ...
    private void getdata() {
        ...
        if(isNetworkAvailable()) {
            ...
            String url = "https://fmgrocery.in/wp-json/wc/v2/products/?search="+searchval.getText().toString().trim()+"&page=" + i;
    ...
    private boolean isNetworkAvailable() {
        ConnectivityManager connectivityManager
                = (ConnectivityManager) SearchProduct.this.getSystemService(Context.CONNECTIVITY_SERVICE);
